    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>ui/js/highcharts/standalone-framework.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>ui/js/highcharts/highcharts.js"></script>
